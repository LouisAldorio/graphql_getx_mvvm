...
class Comments extends GetView<CommentsViewModel> {
  ...
  // final CommentsViewModel viewModel = Get.put(CommentsViewModel());
              ...
              : NotificationListener(
                  child: Builder(
                      builder: (context) => ListView.builder(
                          itemCount: page < controller.result.value.metadata!.totalPages!.toInt()
                          ...
                          itemBuilder: (context, index) {
                            if (index == controller.result.value.data!.length &&
                                page <= controller.result.value.metadata!.totalPages!.toInt()) {
                              return Center(
                                child: Container(
                  ...
                  onNotification: (dynamic t) {
                    if (t is ScrollEndNotification &&
                        ...
                        page < controller.result.value.metadata!.totalPages!.toInt()) {
                      page += 1;
                      controller.getComments(page, limit);
                    }
                    return true;
                  },
                ),
